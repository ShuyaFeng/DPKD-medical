#!/bin/bash
#SBATCH --job-name=sel_abl_kvasir
#SBATCH --partition=amperenodes-medium
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=0-08:00:00
#SBATCH --output=/home/ab36/DPKD-medical/phase1_distillation/slurm_logs/sel_abl_kvasir_%j.out
#SBATCH --error=/home/ab36/DPKD-medical/phase1_distillation/slurm_logs/sel_abl_kvasir_%j.err

echo "=========================================="
echo "Kvasir channel selection ablation"
