#!/bin/bash
#SBATCH --job-name=shared_vs_scratch
...
#SBATCH --output=/data/user/home/ialam/mmsegmentation/slurm_out/shared_vs_scratch_%j.out
#SBATCH --error=/data/user/home/ialam/mmsegmentation/slurm_out/shared_vs_scratch_%j.err
