...
#SBATCH --output=/home/ialam/DPKD-medical/phase1_distillation/slurm_logs/final_canal_kvasir_%j.out
#SBATCH --error=/home/ialam/DPKD-medical/phase1_distillation/slurm_logs/final_canal_kvasir_%j.err
