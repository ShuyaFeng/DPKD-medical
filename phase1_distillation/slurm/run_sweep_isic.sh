...
# Sweep over f_caps and clip_caps_type
# f_caps controls how much budget goes to caps privatization
# the rest (1 - f_caps) goes equally to both CANAL and uniform for channel noise
