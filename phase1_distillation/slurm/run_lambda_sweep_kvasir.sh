#!/bin/bash
#SBATCH --job-name=lambda_sw_kvasir
#SBATCH --partition=amperenodes-medium
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=0-12:00:00
#SBATCH --output=/home/ab36/DPKD-medical/phase1_distillation/slurm_logs/lambda_sweep_kvasir_%j.out
#SBATCH --error=/home/ab36/DPKD-medical/phase1_distillation/slurm_logs/lambda_sweep_kvasir_%j.err

echo "=========================================="
echo "Lambda (feature loss weight) sweep — Kvasir"
