#!/bin/bash
#SBATCH --job-name=more_teach_busi
#SBATCH --partition=amperenodes-medium
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=0-14:00:00
#SBATCH --output=/home/ab36/DPKD-medical/phase1_distillation/slurm_logs/more_teachers_busi_%j.out
#SBATCH --error=/home/ab36/DPKD-medical/phase1_distillation/slurm_logs/more_teachers_busi_%j.err

echo "=========================================="
echo "More teachers K=3,5,7 — BUSI"
