...
#SBATCH --output=/home/ab36/DPKD-medical/phase1_distillation/slurm_logs/rand_sel_v2_busi_%j.out
#SBATCH --error=/home/ab36/DPKD-medical/phase1_distillation/slurm_logs/rand_sel_v2_busi_%j.err

echo "=========================================="
echo "Random vs importance selection v2 (+ rand_canal) — BUSI"
